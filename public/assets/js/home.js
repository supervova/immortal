(() => {
  ...
  function initializeAnimation() {
    ...
    if (slideshowImages.length && textBlocks.length) {
      gsapWithCSS.set(slideshowImages, {
      ...
      slideshowImages.forEach((image, index) => {
        if (index < slideshowImages.length - 1) {
          ...
          const slideAnimation = gsapWithCSS.timeline({
            scrollTrigger: {
              trigger: nextText,
              start: "top 75%",
              end: "top 25%",
          ...
          slideAnimation.to(currentImage, {
            opacity: 0,
            rotationY: 45,
            duration: 0.6,
            ease: "power2.inOut"
    ...
    messages.forEach((message) => {
      gsapWithCSS.fromTo(
        ...
        {
          y: 100,
          // Элемент стартует ниже своей позиции
          opacity: 0
          // Невидимый
        },
        {
          y: 0,
          // Приезжает в свое положение
          opacity: 1,
          // Становится видимым
          ease: "power2.out",
          // Плавная анимация
          ...
          scrollTrigger: {
            trigger: message,
            // Анимация активируется для элемента
            start: "top 80%",
            // Стартует, когда верх элемента достигает 80% экрана
            end: "bottom 20%",
            // Останавливается, когда низ элемента достигает 20% экрана
            toggleActions: "play none none reverse"
            // Перематываем назад при прокрутке вверх
          }
        }
      );
      ...
      if (children.length > 0) {
        gsapWithCSS.fromTo(
          ...
          },
          {
            ...
            scrollTrigger: {
              trigger: message,
              // Триггер для дочерних элементов тот же, что и у родителя
              start: "top 80%",
              toggleActions: "play none none reverse"
            }
          }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll('[data-role="open-modal-alt"]').forEach((button) => {
